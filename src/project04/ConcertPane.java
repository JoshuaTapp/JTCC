...
public class ConcertPane extends GridPane {
    ...
    protected ConcertPane() {
        ...
        super.add(new Label("Performancers:"    ), 0, 3); super.add(this.getTfPerformers(), 1, 3);
        super.add(new Label("Sunnny:"           ), 0, 4); super.add(this.getHBoxSunny   (), 1, 4); super.add(new Label("Temperature:" ), 2, 4); super.add(this.getTfTemperature(), 3, 4);
        super.add(new Label("Wind Speed:"       ), 0, 5); super.add(this.getTfWindSpeed (), 1, 5); super.add(new Label("Humidity:"    ), 2, 5); super.add(this.getTfHumidity   (), 3, 5);
    ...
    public final TextField getTfTemperature() {return this.tfTemperature;}
    public final TextField getTfWindSpeed  () {return this.tfWindSpeed  ;}
    public final TextField getTfHumidity   () {return this.tfHumidity   ;}

    public final RadioButton getRbSunnyYes() {return this.rbSunnyYes;}
    public final RadioButton getRbSunnyNo () {return this.rbSunnyNo ;}

    public final ToggleGroup getSunnyGroup() {return this.sunnyGroup;}

    public final HBox getHBoxSunny() {return this.hBoxSunny;}
    ...
    public RadioButton getRbGoodWeatherYes() {return this.rbGoodWeatherYes;}
    public RadioButton getRbGoodWeatherNo () {return this.rbGoodWeatherNo ;}

    public Label getLblGoodWeather () {return this.lblGoodWeather ;}
    public HBox  getHBoxGoodWeather() {return this.hBoxGoodWeather;}
    ...
    public void submit() {
        ...
        try { event = new Concert(name, place, dateTime, audience, performers, type, weather);} catch (ParseException ex) {}
