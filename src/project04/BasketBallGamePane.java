...
public class BasketBallGamePane extends GridPane {
    ...
    public void submit() {
        ...
        try {event = new BasketBallGame(name, place, dateTime, audience, teams, scores, league);} catch (ParseException ex) {}

        this.getTfWinnerName().setText(((project04.SportEvent)event).getWinnerName());
