...
public class SoccerGamePane extends GridPane {
    ...
    protected SoccerGamePane() {
        ...
        super.add(new Label("Sunnny:"           ), 0, 5); super.add(this.getHBoxSunny  (), 1, 5); super.add(new Label("Temperature:" ), 2, 5); super.add(this.getTfTemperature(), 3, 5);
        super.add(new Label("Wind Speed:"       ), 0, 6); super.add(this.getTfWindSpeed(), 1, 6); super.add(new Label("Humidity:"    ), 2, 6); super.add(this.getTfHumidity   (), 3, 6);
    ...
    public void submit() {
        ...
        try { event = new SoccerGame(name, place, dateTime, audience, teams, scores, league, weather);} catch (ParseException ex) {}
