...
import project02.Event;
import project02.SportEvent;
import project02.MusicEvent;
import project02.ArtEvent;
import project02.BasketBallGame;
import project02.SoccerGame;
import project02.Concert;
import project02.Orchestra;
...
public class TestEvent {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        calendar.set(2018, Calendar.JULY, 28, 10, 0);  // 07/28/2018, 10:00
        ...
        calendar.set(2018, Calendar.JULY, 29, 13, 30);  // 07/29/2018, 13:30
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, Calendar.AUGUST, 1, 20, 0);  // 08/01/2018, 20:00
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, Calendar.AUGUST, 2, 10, 0);  // 08/02/2018, 10:00
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, Calendar.AUGUST, 2, 20, 30);  // 08/02/2018, 20:30
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, Calendar.AUGUST, 3, 10, 30);  // 08/03/2018, 10:30
        dateTime = calendar.getTime();
